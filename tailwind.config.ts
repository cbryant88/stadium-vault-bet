  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "stadium-glow": {
          "0%, 100%": {
            boxShadow: "0 0 20px hsl(var(--stadium-glow) / 0.3)",
          },
          "50%": {
            boxShadow: "0 0 30px hsl(var(--stadium-glow) / 0.6)",
          },
        },
        "live-pulse": {
          "0%, 100%": {
      ...
      animation: {
        ...
        "stadium-glow": "stadium-glow 2s ease-in-out infinite",
